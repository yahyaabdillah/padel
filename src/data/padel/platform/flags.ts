...
export const featureModules: FeatureModule[] = [
  ...
  { key: "coaching", name: "Coaching", description: "Coaches, classes, clinics & PT.", category: "Growth", includedIn: ["pro", "enterprise"] },
  { key: "matches", name: "Open Play & Matches", description: "Americano / Mexicano, leaderboard.", category: "Growth", includedIn: ["pro", "enterprise"] },
